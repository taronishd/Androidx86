...
public class NavigationBarView extends LinearLayout {
    ...
    private void getIcons(Resources res) {
        mBackIcon = res.getDrawable(R.drawable.android_launcher_icon2);
        mBackLandIcon = res.getDrawable(R.drawable.android_launcher_icon2);
        mBackAltIcon = res.getDrawable(R.drawable.android_launcher_icon2);
        mBackAltLandIcon = res.getDrawable(R.drawable.android_launcher_icon2);
